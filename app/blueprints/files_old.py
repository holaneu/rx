"""
Files Blueprint - File system management routes

This blueprint handles all file-related routes:
- File browser (/files, /files/folder/<id>)
- File detail view (/files/file/<id>)
- File operations (future CRUD operations)

Separated to provide focused file management functionality
and potential for different access control.
"""
...
# Create files blueprint with '/files' prefix
